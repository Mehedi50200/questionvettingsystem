...
<html>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div class="navbar-nav">
              ...
              <a class="nav-item nav-link " href="cuserprofile.php"><?php echo $_SESSION['username']; ?></a>
    ...
    <body> 
        ...
        <div class="row justify-content-center">
            ...
            <?php 
            echo"<a href =coursecoordinatorcourse.php?id=".$row['coursecode']." ".">" ?>	          
            <div class="coursewidget scene_element scene_element--fadeinleft">
              <div class="row justify-content-center">
