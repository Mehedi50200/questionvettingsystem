...
<html>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <a class="navbar-brand panelname" href="programcoordinatorhome.php"> Program Coordinator Panel </a>
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
        <span class="navbar-toggler-icon"></span>
        </button>
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                <a class="nav-item nav-link " href="programcoordinatorhome.php">Home</a>
                <a class="nav-item nav-link active" href="#"> / <?php echo $_GET['id'] ; ?><span class="sr-only">(current)</span></a>
                <a class="nav-item nav-link cusername" href="puserprofile.php"><?php echo $_SESSION['username']; ?></a>
            ...
            <div class="row justify-content-center ">  
                <div class="col-7">          
                    <div class="pdfviewer" id="pdfviewer">  
                        <div class="row justify-content-center">
                            <div class= clu>
                                <button class="btn" onclick="printpdf()">Print Report</button>
                            ...
                            <form method="post" action="server.php">
                                ...
                                <input type="hidden" class="form-control" name="coursecode" value="<?php echo $_GET['id']?>">
                                    <div class="input-group-append">
                                        <input type="text" class="form-control" id="procomment" name="procomment">
                                    </div>
                                    <div class="input-group-append">
                                        <button class="btn" type="submit" name="disapprove">Disapprove</button>
                                    </div>
                                    <div class="input-group-append">
